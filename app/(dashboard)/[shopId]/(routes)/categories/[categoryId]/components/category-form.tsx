...
export const CategoryForm: React.FC<CategoryFormProps> = ({ initialData, billboards }) => {
  ...
  const onSubmit = async (data: CategoryFormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await axios.patch(`/api/${params.shopId}/categories/${params.categoryId}`, data);
      } else {
        await axios.post(`/api/${params.shopId}/categories`, data);
      }
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${params.shopId}/categories/${params.categoryId}`);
